  ...
  return (
    <m.header
      ...
      className={cn(
        ...
        scrolled
          ? 'bg-surface/80 backdrop-blur-xl border-b border-surface-300 shadow-lg'
          : 'bg-transparent'
      )}
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Button variant="accent" size="sm" onClick={() => open()}>
            Get a Quote
          </Button>
        </div>
        ...
        {/* Mobile hamburger */}
        <button
          className="md:hidden rounded-lg p-2 text-text-muted hover:text-text"
      ...
      <m.div
        ...
        className="overflow-hidden md:hidden bg-surface-100/95 backdrop-blur-xl border-b border-surface-300"
      >
